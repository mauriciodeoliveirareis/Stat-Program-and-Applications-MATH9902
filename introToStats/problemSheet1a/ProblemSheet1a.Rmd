...
Cons:  
It's sensitive to extreme values. Looks what happens for the mean salary from Merit Market editors when mister Merit Jr. becomes 18 and starts working on the department:
```{r}
...
Cons: The set must be ordered, you can make a calculation up in your head that easily. Also, It doesn't use all the data set so, if your distribution is left or right skewed, it might be misleading used alone

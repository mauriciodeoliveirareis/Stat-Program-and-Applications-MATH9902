...
---
**ATTENTION, I NEED TO REFACTOR THIS AS THERE ARE WRONG ANSWERS HERE
Problem Sheet 1b
...
From Trump voters: 0.04 * 0.5 = 0.02
From others: 0.96 * 0.083 = 0.079
Total Skeptcs (Also prevalence/prob in total): 0.081


b) If a voter is selected and they are a climate change sceptic, determine the probability that they will vote for Trump.!!!This is wrong !!!
"has the desease" = 4%(vote for trump)
"test positive" = climate skeptc 
prevalence = total skeptics

sensitivity = 0.5
prevalence = 0.081
specifity =  (1 - 0.083) = 0.917   


$$ \frac{0.5 * 0.081}{0.5 * 0.081 + (1-0.081) * (1 - 0.917)} $$
```{r}
(0.5 * 0.081) / ( (0.5 * 0.081) + (1 - 0.081) * (1-0.917))
```
...
From Trump voters: 0.38 * 0.2 = 0.076  
from other voters: 0.62 * 0.01 = 0.0062  
Prevalence = 0.0822  

b) If a voter is selected and they are a birther, determine the probability that they will vote for
Trump.  
sensitivity = 0.2   
prevalence = 0.0822  
specifity = 0.99  
$$ \frac{0.2 * 0.0822}{0.2 * 0.0822 + (1-0.0822) * (1 - 0.99)} $$
```{r}
(0.2 * 0.0822) / ( (0.2 * 0.0822) + (1 - 0.0822) * (1-0.99))
```

9\. In a school 30% of the students are male. Of these males 20% have long hair, while 90% of the
female students have long hair.

i Find the probability that a student selected has long hair.\
of men -> 0.3 * 0.2 = 0.06  
of women -> 0.7 * 0.9 = 0.63
Total -> 0.69  

ii If a student is selected and they have long hair, determine the probability that the student is male.  !!!This is wrong !!!
prevalence = 0.69  
sensitivity = 0.2  
specificity = 0.1  
$$ \frac{0.2 * 0.69}{0.2 * 0.69 + (1-0.69) * (1 - 0.1)} $$  
  

```{r}
(0.2 * 0.69) / ( (0.2 * 0.69) + (1 - 0.69) * (1-0.1))
```
